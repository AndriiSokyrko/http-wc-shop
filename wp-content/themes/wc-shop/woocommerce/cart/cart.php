...
<form action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<div class="shop_table shop_table_responsive cart cart-gd">
		...
		<div
			...
			<?php
				echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
					'<a href="%s" class="remove close1" title="%s" data-product_id="%s" data-product_sku="%s">&times;</a>',
		...
		?>
			<div class="actions contact-form">


				<?php if ( wc_coupons_enabled() ) { ?>
					<div class="coupon">

						<div class=""><label for="coupon_code"><?php _e( 'Coupon', 'woocommerce' ); ?>:</div>
